...
export const aboutInfo: AboutInfo = {
  ...
  skills: [
    { name: 'React', nameEn: 'React', level: 90, category: 'frontend' },
    { name: 'TypeScript', nameEn: 'TypeScript', level: 85, category: 'frontend' },
    { name: 'Vue.js', nameEn: 'Vue.js', level: 80, category: 'frontend' },
    { name: 'Go', nameEn: 'Go', level: 75, category: 'backend' },
    { name: 'Node.js', nameEn: 'Node.js', level: 80, category: 'backend' },
    { name: 'Python', nameEn: 'Python', level: 70, category: 'backend' },
    { name: 'Docker', nameEn: 'Docker', level: 85, category: 'devops' },
    { name: 'Kubernetes', nameEn: 'Kubernetes', level: 70, category: 'devops' },
    { name: 'CI/CD', nameEn: 'CI/CD', level: 80, category: 'devops' },
    { name: 'Git', nameEn: 'Git', level: 90, category: 'tools' },
    { name: 'Linux', nameEn: 'Linux', level: 85, category: 'tools' },
    { name: 'PostgreSQL', nameEn: 'PostgreSQL', level: 75, category: 'tools' },
  ],
}
